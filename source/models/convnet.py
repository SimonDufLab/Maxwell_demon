...
def conv_3_2(sizes, number_classes, dim=2):
    ...
    layer_2 = [max_pool, Partial(conv_fn, 2*sizes[0], 3), act]
    layer_3 = [max_pool, Partial(conv_fn, 4*sizes[0], 3), act]
    layer_4 = [bigger_max_pool, hk.Flatten, Partial(hk.Linear, sizes[1]), act]
...
def conv_4_2(sizes, number_classes, dim=2):
    ...
    layer_2 = [max_pool, Partial(conv_fn, 2*sizes[0], 3), act]
    layer_3 = [max_pool, Partial(conv_fn, 4*sizes[0], 3), act]
    layer_4 = [max_pool, Partial(conv_fn, 4 * sizes[0], 3), act]
    layer_5 = [bigger_max_pool, hk.Flatten, Partial(hk.Linear, sizes[1]), act]
...
def conv_6_2(sizes, number_classes, dim=2):
    ...
    layer_1 = [Partial(conv_fn, sizes[0], 3), act]
    layer_2 = [Partial(conv_fn, sizes[0], 3), act]
    layer_3 = [max_pool, Partial(conv_fn, 2*sizes[0], 3), act]
    layer_4 = [Partial(conv_fn, 2*sizes[0], 3), act]
    layer_5 = [max_pool, Partial(conv_fn, 4*sizes[0], 3), act]
    layer_6 = [max_pool, Partial(conv_fn, 4*sizes[0], 3), act]
    layer_7 = [bigger_max_pool, hk.Flatten, Partial(hk.Linear, sizes[1]), act]
